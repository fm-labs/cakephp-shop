        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?= $this->Html->link(__d('shop','Change'), ['action' => 'billing', 'change' => true, 'ref' => 'review']); ?>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?= $this->Html->link(__d('shop','Change'), ['action' => 'shipping', 'change' => true, 'ref' => 'review']); ?>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    > <?= $this->Html->link(__d('shop','Change'), ['action' => 'payment', 'ref' => 'review']); ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="desc" style="font-size: 90%;">
                        ...
                        <?= $this->Html->link(__d('shop','Change'), ['action' => 'shipping', 'change_type' => true, 'ref' => 'review']); ?>
                    </div>
                </div>
            </div>
