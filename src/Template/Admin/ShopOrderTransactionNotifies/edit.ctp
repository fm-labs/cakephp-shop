...
<?php $this->Breadcrumbs->add(__('Edit {0}', __('Shop Order Transaction Notify'))); ?>
<?php $this->Toolbar->addPostLink(
    __('Delete'),
    ['action' => 'delete', $shopOrderTransactionNotify->id],
    ['data-icon' => 'trash', 'confirm' => __('Are you sure you want to delete # {0}?', $shopOrderTransactionNotify->id)]
)
?>
...
<div class="form">
    <h2 class="ui header">
        <?= __('Edit {0}', __('Shop Order Transaction Notify')) ?>
    </h2>
