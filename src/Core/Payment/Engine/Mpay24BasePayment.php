...
abstract class Mpay24BasePayment implements PaymentEngineInterface
{
    ...
    abstract protected function _pay(Mpay24 $mpay24, MPay24Order $mdxi);
    ...
    public function pay(PaymentComponent $Payment, ShopOrder $order, ShopOrderTransaction $transaction)
    {
        ...
        try {
            ...
            $mdxi->Order->TemplateSet->setCSSName("MODERN"); // "WEB"
            ...
            */
            ...
            $mdxi->Order->URL->Cancel = Router::url($Payment->getConfirmUrl(), true);
            ...
            $mpay24Response = $this->_pay($mpay24, $mdxi);
            debug($mpay24Response);
