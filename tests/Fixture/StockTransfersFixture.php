...
/**
 * StockTransfersFixture
 *
 */
class StockTransfersFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'shop_stock_transfers';
    ...
    public $fields = [
        ...
        'op' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
